...
Why yes! Normally, it never trims away your very last stack of anything, because we can't tell if it was something you actually wanted to keep. But if you set a logistics request for the item with a _minimum set to zero_ (which is normally meaningless), the trimmer will know you really are happy for a minimum of zero slots and will clear them out.
